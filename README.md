...
猫之琴是一款本地运行的自动弹琴辅助工具，支持 `MIDI` 和 `TXT` 乐谱。只要游戏内有 21 个琴键，就可以自动弹奏。你可以把它当作一个“游戏音乐播放器”，控制速度、单曲循环或列表循环。
...
- 可调节弹奏速度
- 支持单曲循环、列表循环
- 支持 PC、安卓手机弹奏、安卓手机点赞三种模式
- 支持热键快捷操作

## 下载安装

直接下载 Releases 中的压缩包，解压后运行 `猫之琴轻量版.exe` 即可，无需安装 Python。

👉 [下载猫之琴 v1.0.0](https://github.com/osirisaewqsd/GM1/releases/tag/v1.0.0)

手机控制所需的 `GMAUT.apk` 已包含在 Releases 压缩包内。
